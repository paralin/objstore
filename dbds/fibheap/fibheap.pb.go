...
/*
Package fibheap is a generated protocol buffer package.

It is generated from these files:
	github.com/aperturerobotics/objstore/dbds/fibheap/fibheap.proto
...
func (m *Entry) SetNext(val string) {
	if m != nil {
		m.Next = val
	}
}
...
func init() {
	proto.RegisterFile("github.com/aperturerobotics/objstore/dbds/fibheap/fibheap.proto", fileDescriptor0)
}
